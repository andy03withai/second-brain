...
## 用户偏好记录 (2026-03-18 更新)

### 返回格式偏好
**所有涉及第二大脑的内容，必须附带网络链接**

- 文章收录 → 返回 `https://andy03withai.github.io/second-brain/articles/YYYYMMDD-article-name/`
- 深度调研 → 返回 `https://andy03withai.github.io/second-brain/deep-research/YYYY-MM-DD-research-topic/`
- 技能/脚本 → 返回 `https://andy03withai.github.io/second-brain/skills/skill-name/`
- 每日简报 → 返回 `https://andy03withai.github.io/second-brain/input/YYYYMMDD/`
- 复盘报告 → 返回 `https://andy03withai.github.io/second-brain/input/ace-reviews/YYYY-WXX/`

**原因**: 方便用户直接在浏览器中查看最终渲染效果

---

## 杭州城市活动追踪 (2026-04-22)

**功能**: 每天自动生成杭州未来一周城市活动列表  
**覆盖日期**: 2026年4月22日~4月29日  
**时间**: 每天早上 8:00 (Asia/Shanghai)  
...
## 长三角城市活动追踪 (2026-04-10)

**功能**: 每天自动生成长三角未来一周城市活动列表  
**覆盖城市**: 上海、南京、苏州、宁波、无锡、合肥、嘉兴、绍兴、金华等  
**时间**: 每天早上 8:00 (Asia/Shanghai)  
**Cron Job ID**: `53fcaae6-e9dd-4eb1-a601-5efa3f64879a`  
**访问地址**: `https://andy03withai.github.io/second-brain/input/yangtze-events/YYYY-MM-DD`
