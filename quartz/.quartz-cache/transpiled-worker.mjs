...
var customComponents = {
  table: (props) => /* @__PURE__ */ React.createElement("div", { class: "table-container" }, /* @__PURE__ */ React.createElement("table", { ...props }))
};
...
function ExplorerNode({ node, opts, fullPath, fileData }) {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, node.file ? (
    // Single file node
    /* @__PURE__ */ React.createElement("li", { key: node.file.slug }, /* @__PURE__ */ React.createElement("a", { href: resolveRelative(fileData.slug, node.file.slug), "data-for": node.file.slug }, node.displayName))
  ) : /* @__PURE__ */ React.createElement("li", null, node.name !== "" && // Node with entire folder
  // Render svg button + folder name, then children
  /* @__PURE__ */ React.createElement("div", { class: "folder-container" }, /* @__PURE__ */ React.createElement(
    "svg",
    {
      xmlns: "http://www.w3.org/2000/svg",
      width: "12",
    ...
    /* @__PURE__ */ React.createElement("polyline", { points: "6 9 12 15 18 9" })
  ), /* @__PURE__ */ React.createElement("div", { key: node.name, "data-folderpath": folderPath }, folderBehavior === "link" ? /* @__PURE__ */ React.createElement("a", { href, "data-for": node.name, class: "folder-title" }, node.displayName) : /* @__PURE__ */ React.createElement("button", { class: "folder-button" }, /* @__PURE__ */ React.createElement("span", { class: "folder-title" }, node.displayName)))), /* @__PURE__ */ React.createElement("div", { class: `folder-outer ${node.depth === 0 || isDefaultOpen ? "open" : ""}` }, /* @__PURE__ */ React.createElement(
    "ul",
    {
      style: {
    ...
    node.children.map((childNode, i) => /* @__PURE__ */ React.createElement(
      ExplorerNode,
      {
        node: childNode,
        key: i,
...
var Explorer_default = /* @__PURE__ */ __name((userOpts) => {
  ...
  const Explorer = /* @__PURE__ */ __name(({
    ...
    return /* @__PURE__ */ React.createElement("div", { class: classNames(displayClass, "explorer") }, /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
        id: "explorer",
      ...
      /* @__PURE__ */ React.createElement("h2", null, opts.title ?? i18n(cfg.locale).components.explorer.title),
      /* @__PURE__ */ React.createElement(
        "svg",
        {
          xmlns: "http://www.w3.org/2000/svg",
    ...
    ), /* @__PURE__ */ React.createElement("div", { id: "explorer-content" }, /* @__PURE__ */ React.createElement("ul", { class: "overflow", id: "explorer-ul" }, /* @__PURE__ */ React.createElement(ExplorerNode, { node: fileTree, opts, fileData }), /* @__PURE__ */ React.createElement("li", { id: "explorer-end" }))));
  }, "Explorer");
...
var Search_default = /* @__PURE__ */ __name((userOpts) => {
  const Search = /* @__PURE__ */ __name(({ displayClass, cfg }) => {
    ...
    return /* @__PURE__ */ React.createElement("div", { class: classNames(displayClass, "search") }, /* @__PURE__ */ React.createElement("button", { class: "search-button", id: "search-button" }, /* @__PURE__ */ React.createElement("p", null, i18n(cfg.locale).components.search.title), /* @__PURE__ */ React.createElement("svg", { role: "img", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 19.9 19.7" }, /* @__PURE__ */ React.createElement("title", null, "Search"), /* @__PURE__ */ React.createElement("g", { class: "search-path", fill: "none" }, /* @__PURE__ */ React.createElement("path", { "stroke-linecap": "square", d: "M18.5 18.3l-5.4-5.4" }), /* @__PURE__ */ React.createElement("circle", { cx: "8", cy: "8", r: "7" })))), /* @__PURE__ */ React.createElement("div", { id: "search-container" }, /* @__PURE__ */ React.createElement("div", { id: "search-space" }, /* @__PURE__ */ React.createElement(
      "input",
      {
        autocomplete: "off",
        id: "search-bar",
...
var Footer_default = /* @__PURE__ */ __name((opts) => {
  const Footer = /* @__PURE__ */ __name(({ displayClass, cfg }) => {
    ...
    return /* @__PURE__ */ React.createElement("footer", { class: `${displayClass ?? ""}` }, /* @__PURE__ */ React.createElement("p", null, i18n(cfg.locale).components.footer.createdWith, " ", /* @__PURE__ */ React.createElement("a", { href: "https://quartz.jzhao.xyz/" }, "Quartz v", version), " \xA9 ", year), /* @__PURE__ */ React.createElement("ul", null, Object.entries(links).map(([text, link]) => /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("a", { href: link }, text)))));
  }, "Footer");
